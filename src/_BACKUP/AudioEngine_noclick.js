...
async play() {
  ...
  if (!this.isPlaying) {
    ...
    // Получаем синглтон визуального планировщика и запускаем
    const visualScheduler = await import('./VisualScheduler').then(module => module.default);
    // Устанавливаем ссылку на аудиодвижок
    visualScheduler.setAudioEngine(this);
    // Запускаем визуальный планировщик
    visualScheduler.start();
  }
...
pause() {
  if (this.isPlaying) {
    ...
    // Получаем синглтон визуального планировщика и ставим на паузу
    const visualScheduler = require('./VisualScheduler').default;
    visualScheduler.pause();
  }
  return true;
}
...
stop() {
  ...
  // Получаем синглтон визуального планировщика и останавливаем
  const visualScheduler = require('./VisualScheduler').default;
